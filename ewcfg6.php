...
define("EW_PROJECT_NAME", "sispromers2", TRUE); // Project Name
define("EW_RANDOM_KEY", '6e7JlpmW3oQzCouy', TRUE); // Random key for encryption
...
define("EW_ADMIN_PASSWORD", "8209125", TRUE); // Administrator password

// Dynamic User Level table
//$EW_USER_LEVEL_TABLE_NAME[] = 'administrador';
//$EW_USER_LEVEL_TABLE_CAPTION[] = "Administrador";
//$EW_USER_LEVEL_TABLE_NAME[] = 'archivo';
//$EW_USER_LEVEL_TABLE_CAPTION[] = "Archivo";
$EW_USER_LEVEL_TABLE_NAME[] = 'comunidad';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Comunidad";
//$EW_USER_LEVEL_TABLE_NAME[] = 'contrato_llenar';
//$EW_USER_LEVEL_TABLE_CAPTION[] = "Contrato Llenar";
$EW_USER_LEVEL_TABLE_NAME[] = 'departamento';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Departamento";
$EW_USER_LEVEL_TABLE_NAME[] = 'formulario';
$EW_USER_LEVEL_TABLE_CAPTION[] = "20 Formularios";
//$EW_USER_LEVEL_TABLE_NAME[] = 'historial_archivo';
//$EW_USER_LEVEL_TABLE_CAPTION[] = "Historial Archivo";
//$EW_USER_LEVEL_TABLE_NAME[] = 'historial_contrato';
//$EW_USER_LEVEL_TABLE_CAPTION[] = "Historial Contrato";
//$EW_USER_LEVEL_TABLE_NAME[] = 'historial_formulario';
//$EW_USER_LEVEL_TABLE_CAPTION[] = "Historial Formulario";
$EW_USER_LEVEL_TABLE_NAME[] = 'mer';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Mer";
$EW_USER_LEVEL_TABLE_NAME[] = 'municipio';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Municipio";
//$EW_USER_LEVEL_TABLE_NAME[] = 'obtencion_credito16';
//$EW_USER_LEVEL_TABLE_CAPTION[] = "Obtencion Credito 16";
$EW_USER_LEVEL_TABLE_NAME[] = 'planilla';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Formularios";
//$EW_USER_LEVEL_TABLE_NAME[] = 'pregunta';
//$EW_USER_LEVEL_TABLE_CAPTION[] = "Pregunta";
//$EW_USER_LEVEL_TABLE_NAME[] = 'pregunta_respuesta';
//$EW_USER_LEVEL_TABLE_CAPTION[] = "Pregunta Respuesta";
$EW_USER_LEVEL_TABLE_NAME[] = 'regional';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Regional";
//$EW_USER_LEVEL_TABLE_NAME[] = 'registro_contrato';
//$EW_USER_LEVEL_TABLE_CAPTION[] = "Registro Contrato";
//$EW_USER_LEVEL_TABLE_NAME[] = 'registroventas17';
//$EW_USER_LEVEL_TABLE_CAPTION[] = "Registroventas 17";
$EW_USER_LEVEL_TABLE_NAME[] = 'responsable';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Responsable";
$EW_USER_LEVEL_TABLE_NAME[] = 'rubro';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Rubro";
$EW_USER_LEVEL_TABLE_NAME[] = 'tipo_contrato';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Tipo Contrato";
$EW_USER_LEVEL_TABLE_NAME[] = 'usuario';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Usuario";
//$EW_USER_LEVEL_TABLE_NAME[] = 'Reporte Mers';
//$EW_USER_LEVEL_TABLE_CAPTION[] = "Reporte Mers";
$EW_USER_LEVEL_TABLE_NAME[] = 'matriz_marco_logico';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Matriz de Marco Logico";
$EW_USER_LEVEL_TABLE_NAME[] = 'resumen_linea_base';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Resumen Linea de Base";
$EW_USER_LEVEL_TABLE_NAME[] = 'reporte_mml';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Reporte MML";

$EW_USER_LEVEL_TABLE_NAME[] = 'reporte_indicadores';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Reporte Grafico Indicadores";

$EW_USER_LEVEL_TABLE_NAME[] = 'reporte_rubros';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Reporte Rubros";
$EW_USER_LEVEL_TABLE_NAME[] = 'mers_fortalecidas';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Reporte Mers Fortalecidas";
$EW_USER_LEVEL_TABLE_NAME[] = 'reporte_general';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Reporte General";
$EW_USER_LEVEL_TABLE_NAME[] = 'indicador_impacto';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Indicador de Impacto";
$EW_USER_LEVEL_TABLE_NAME[] = 'indicador1';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Indicador 1";
$EW_USER_LEVEL_TABLE_NAME[] = 'indicador2';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Indicador 2";
$EW_USER_LEVEL_TABLE_NAME[] = 'indicador3';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Indicador 3";
$EW_USER_LEVEL_TABLE_NAME[] = 'indicador4';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Indicador 4";
$EW_USER_LEVEL_TABLE_NAME[] = 'indicador5';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Indicador 5";
$EW_USER_LEVEL_TABLE_NAME[] = 'indicador6';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Indicador 6";
$EW_USER_LEVEL_TABLE_NAME[] = 'indicador7';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Indicador 7";
$EW_USER_LEVEL_TABLE_NAME[] = 'indicador8';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Indicador 8";
$EW_USER_LEVEL_TABLE_NAME[] = 'indicador9';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Indicador 9";
$EW_USER_LEVEL_TABLE_NAME[] = 'indicador10';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Indicador 10";
$EW_USER_LEVEL_TABLE_NAME[] = 'indicador11';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Indicador 11";
$EW_USER_LEVEL_TABLE_NAME[] = 'indicador12';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Indicador 12";
$EW_USER_LEVEL_TABLE_NAME[] = 'indicador13';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Indicador 13";
$EW_USER_LEVEL_TABLE_NAME[] = 'indicador14';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Indicador 14";
$EW_USER_LEVEL_TABLE_NAME[] = 'consultoria';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Consultoria";
$EW_USER_LEVEL_TABLE_NAME[] = 'cronograma';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Cronograma";
$EW_USER_LEVEL_TABLE_NAME[] = 'responsable_consultoria';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Asignar Revisor a Consultoria";
$EW_USER_LEVEL_TABLE_NAME[] = 'avance_producto';
$EW_USER_LEVEL_TABLE_CAPTION[] = "Avance de Producto";
$EW_USER_LEVEL_TABLE_NAME[] = 'reporte_seguimiento_consultoria';
...
define("EW_USER_LEVEL_TABLE", "`rol`", TRUE);
define("EW_USER_LEVEL_ID_FIELD", "`idRol`", TRUE);
define("EW_USER_LEVEL_NAME_FIELD", "`nombre`", TRUE);

// User Level privileges table/field names
define("EW_USER_LEVEL_PRIV_TABLE", "`permiso`", TRUE);
define("EW_USER_LEVEL_PRIV_TABLE_NAME_FIELD", "`nombre`", TRUE);
define("EW_USER_LEVEL_PRIV_USER_LEVEL_ID_FIELD", "`idRol`", TRUE);
define("EW_USER_LEVEL_PRIV_PRIV_FIELD", "`permiso`", TRUE);
