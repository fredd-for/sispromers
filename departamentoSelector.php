...
else {$query_mostrar_departamento = "SELECT idDepartamento,departamento FROM departamento ORDER BY departamento ASC";}
...
?>
<select id="x_idDepartamento" name="x_idDepartamento" onchange="seleccionar_municipio();">
    <option value="0" <?php if($_GET['idRegional']=='0'){ echo "selected";}?> style="color:gray">Todos...</option>
  <?php
do {  
?>
