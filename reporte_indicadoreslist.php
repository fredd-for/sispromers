...
<script type="text/javascript">
    ...
    {  $("#x_gestion").change(cargaContenido);
       $("#x_indicador").change(cargaContenido); 
    }
    function cargaContenido(){
        var gestion=$("#x_gestion").attr("value");
        var indicador=$("#x_indicador").attr("value");
        var pagina="reporte_indicadores.php?gestion="+gestion+"&indicador="+indicador;
...
<!--             <option value="0" style="color: gray" >Todos...</option>-->
      ...
      <td>Indicadores</td>
     <td>
         <select name="x_indicador" id="x_indicador">
<!--             <option value="0" style="color: gray" >Seleccione...</option>-->
                        <option value="1" selected>Proposito I.1</option>
                        <option value="2">Proposito I.2</option>
                        <option value="3">Proposito I.3</option>
                        <option value="4">Proposito I.4</option>
			<option value="5">Indicador C.1-I.1</option>
                        <option value="6">Indicador C.1-I.2</option>
                        <option value="7">Indicador C.1-I.3</option>
                        <option value="8">Indicador C.1-I.4</option>
                        <option value="9">Indicador C.2-I.1</option>
                        <option value="10">Indicador C.2-I.2</option>
                        <option value="11">Indicador C.2-I.3</option>
                        <option value="12">Indicador C.3-I.1</option>
                        <option value="13">Indicador C.3-I.2</option>
                        <option value="14">Indicador C.3-I.3</option>
         </select>
     </td>
     </tr>
</table>
