...
// PHPMaker 6 configuration for Table avance_producto
$avance_producto = NULL; // Initialize table object

// Define table class
class cavance_producto {
	...
	function cavance_producto() {
		$this->TableVar = "avance_producto";
		$this->TableName = "avance_producto";
		$this->idConsultoria = new cField('avance_producto', 'x_idConsultoria', 'idConsultoria', "cronograma.idConsultoria", 3, -1, FALSE);
		$this->fields['idConsultoria'] =& $this->idConsultoria;
		$this->idCronograma = new cField('avance_producto', 'x_idCronograma', 'idCronograma', "cronograma.idCronograma", 3, -1, FALSE);
	...
	function HighlightName() {
		return "avance_producto_Highlight";
	}
	...
	function SqlSelect() { // Select
		return "SELECT cronograma.idConsultoria, cronograma.idCronograma FROM cronograma";
	}
	...
	function SqlKeyFilter() {
		return "cronograma.idConsultoria = @idConsultoria@ AND cronograma.idCronograma = @idCronograma@";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[EW_PROJECT_NAME . "_" . $this->TableVar . "_" . EW_TABLE_RETURN_URL] <> "") {
			...
			return "avance_productolist.php";
		}
	}
	...
	// View url
	function ViewUrl() {
		return $this->KeyUrl("avance_productoview.php", $this->UrlParm());
	}

	// Add url
	function AddUrl() {
		$AddUrl = "avance_productoadd.php";
	...
	// Edit url
	function EditUrl() {
		return $this->KeyUrl("avance_productoedit.php", $this->UrlParm());
	}
	...
	// Copy url
	function CopyUrl() {
		return $this->KeyUrl("avance_productoadd.php", $this->UrlParm());
	}
	...
	// Delete url
	function DeleteUrl() {
		return $this->KeyUrl("avance_productodelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=avance_producto" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
