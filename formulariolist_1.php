...
<tr><td>EL MUNICIPIO CONTRATO SERVICIOS DE LA MERS:<td id="idcheck_list"></td></tr>
<tr><td>EN PROCESO %:</td><td id="idcheck_list_porcentaje"></td></tr>
<tr><td>FECHA DEL CONTRATO:</td><td><input type="text" name="x_observacion" id="x_observacion" value="<?php echo $row_formulario['observacion'];?>" class="date-pick" size="12"></td></tr>
</table>
<table cellspacing="0" class="ewTable">
<tr><td colspan="4"><div class="titulo">Ckeck List</div></td></tr>
...
<tr><td>LA MERS PARTICIPO DE EVENTO ORGANIZADO POR EL MUNICIPIO:<td id="idcheck_list"><?php echo $row_formulario['cuenta'];?></td></tr>
<tr><td>OBSERVACIONES:</td><td><input type="text" name="x_observacion" id="x_observacion" value="<?php echo $row_formulario['observacion'];?>" size="150"></td></tr>
</table>
<table cellspacing="0" class="ewTable">
<tr><td colspan="4"><div class="titulo">Ckeck List</div></td></tr>
